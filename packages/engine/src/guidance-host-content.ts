...
7. Present decisions and manual tests in plain English. When a manual-test action has \`visualReview: true\`, call \`storybook_preview\` before asking the developer to review it. Record exact answers through \`answer_decision\` or \`submit_manual_test\`.
